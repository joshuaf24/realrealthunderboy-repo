...
if (image_index == 1) && (global.counter >= 2)
{
	...
	with (oenemy)
	{
		path_start(pleftcounter,10,path_action_stop,false);
	}
}
#endregion
//ENEMY HIT
#region
//if (image_index == 4) && (global.estate == ENEMYSTATE.LEFT_BLOCK)
{
...
if (image_index == 4) && (global.estate == ENEMYSTATE.RIGHT_ATTACK_A)
{
	with (oenemy)
	{
